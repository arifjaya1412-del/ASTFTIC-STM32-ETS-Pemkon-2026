...
4. **Trusted Multi-Protocol:** Transmisi serial diamankan dengan otentikasi pesan menggunakan **HMAC-SHA256** agar aman dari intervensi.

### 🛠️ Lingkungan Pengembangan & Komponen
- **IDE & Bahasa:** STM32CubeIDE (C Language)
- **Mikrokontroler:** STM32F401VET6
- **Simulator Hardware:** Proteus Professional
- **Sensor Suhu:** LM35
